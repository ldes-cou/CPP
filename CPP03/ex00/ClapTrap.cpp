...
/*   Updated: 2022/02/16 23:29:57 by lucrece          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _HitPoints(10), _EnergyPoint(10), _AttackDamage(0)
{
    std::cout << "ClapTrap created - default constructor" << std::endl;
}
ClapTrap::ClapTrap(std::string name): _HitPoints(10), _EnergyPoint(10), _AttackDamage(0)
{
    this->_name = name;
