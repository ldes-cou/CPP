...
/*   Updated: 2022/02/18 10:11:04 by ldes-cou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _HitPoints(100), _EnergyPoint(50), _AttackDamage(20)
{
    std::cout << "ClapTrap created - default constructor" << std::endl;
}

ClapTrap::ClapTrap(std::string name): _HitPoints(100), _EnergyPoint(50), _AttackDamage(20)
{
    this->_name = name;
